...
# This is not used as we preprocess the data with required formatting beforehand to prevent preprocessing during the training.
...
# Testing the trained model for some random input.
inputs = tokenizer(
    [
